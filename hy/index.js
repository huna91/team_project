...
window.onwheel = function (e) {
  ...
  if((ballUp%=7) ==0){
    go.style.transform = 'translate(0,-33.922vw) scale(0.2,0.2)';
    view_img.src=image[index];
    nft_buy.style.boxShadow="rgba(240, 46, 170, 0.3) 0 0 0.136vw 0.136vw, rgba(240, 46, 170, 0.2) 0 0 0.271vw 0.271vw, rgba(240, 46, 170, 0.1) 0 0 0.407vw 0.407vw";
    view_title.innerHTML=title[index];
    view_title.style.borderBottom='0.136vw solid';
...
header_home.addEventListener('mouseenter',function(){
  ...
  setTimeout(function(){
    mLeft.style.transform='translate(0,-8.481vw)';
    mMiddle.style.transform='translate(0,-4.41vw)';
    mRight.style.transform='translate(0,-6.445vw)';
  },50);
})
...
//제목 색 변경해서 넣어주기
let title_color_= new Array;
const title_color= document.querySelectorAll('[class ^= "name"]');
title_color_=["#fc2626","#f29634","#eaf510","#53fc05","#3729cb","#f41fcd"]
// while(1){
//   for(let i=0;i<title_color.length;i++){
    
//     for(let k=0; k<title_color.length;k++){
//       let o=i%title_color.length;
//       title_color[k].style.backgroundColor=title_color_[o];
//     }
